...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function lanzarPetalosRamo() {
        ...
        for (let i = 0; i < 8; i++) {
            ...
            d.style.cssText = `position:fixed; left:${cx}px; top:${cy}px; width:6px; height:6px; border-radius:0 100% 0 100%; background:${colores[Math.floor(Math.random()*colores.length)]}; pointer-events:none; z-index:9999;`;
    ...
    if (corazonFirmaWrapper) {
        corazonFirmaWrapper.addEventListener("click", (e) => {
            e.stopPropagation(); 
            // Expulsa una ráfaga de corazones al hacer clic
